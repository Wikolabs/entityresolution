...
export const metadata: Metadata = {
  title: "EntityResolution — Dé-dupliquez vos données clients à grande échelle",
  description: "Matching ML multi-source 99.3% de précision — un client, un profil unifié, zéro doublon même sur des bases hétérogènes.",
};
